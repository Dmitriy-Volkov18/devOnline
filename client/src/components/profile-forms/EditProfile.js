    ...
    return (
        <Fragment>
            ...
            <form className="form" onSubmit={e => onSubmit(e)}>
                ...
                <div className="form-group">
                    <input type="text" placeholder="Github Имя" name="githubusername" value={githubusername} onChange={e => onChange(e)} />
                ...
                <input type="submit" className="btn btn-primary my-1" value="Редактировать"/>
